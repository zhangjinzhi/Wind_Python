        ...
        for symbol in symbols:
             ...
             try:
                ...
                '''
                 ...
                 stock=w.wsd(symbol, "wgsd_com_eq,trade_status", start_date,end_date, "unit=1;rptType=1;currencyType=;Period=Q;Days=Alldays;PriceAdj=F")
                 # print 'stock is : ',type(stock)
                 # print stock
                 index_data = pd.DataFrame()
                 index_data['trade_date']=stock.Times
                 # print stock.Times
                 # print 'the type of stock.Times is : ',type(stock.Times)
                 # stock.Data[0]=symbol
