...
def get_add_insert_industry():
    ...
    to_table_name,insert_column = "all_stocks_cleaned_factors_table","industry_type"
...
def add_dummy_avariable(table_name):
    ...
    conn = MySQLdb.connect(host='127.0.0.1', user='root', passwd='zjz4818774', db='invest_lastest', port=3306,charset='utf8')
